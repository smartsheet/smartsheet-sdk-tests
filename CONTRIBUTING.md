...
> **_TIP:_**  You can make use of Roo Code or Cluade Code to generate Wiremock mappings. TODO - add more instructions about which modes should be used and how to use them.
